 ...
 * @author Admin
 */
public class ContactList extends javax.swing.JDialog {

    /**
     * Creates new form BillHistory
     */
    public ContactList(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContactList dialog = new ContactList(new javax.swing.JFrame(), true);
